<template>
  <div
    class="bg-[#475569] flex justify-center items-center h-[calc(100vh-60px)] overflow-hidden p-10"
  >
    <div class="max-w-[600px] shadow-lg bg-white rounded-[12px] p-9 gap-[56px]">
      <div class="text-center mt-4">
        <h3 class="text-2xl font-bold">Signin</h3>
      </div>
